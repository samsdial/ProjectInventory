...
const seedProducts = async () => {
  const products = [
    ...
    },
    {
      ...
      warehouse_id: new mongoose.Types.ObjectId("65279b7f69f7b3c23ef9e0a5"),
      image:
        "https://w7.pngwing.com/pngs/428/65/png-transparent-netbook-laptop-dell-xps-computer-hardware-laptop-electronics-gadget-netbook.png",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://w7.pngwing.com/pngs/488/766/png-transparent-power-over-ethernet-ubiquiti-networks-network-switch-ubiquiti-unifi-switch-small-form-factor-pluggable-transceiver-wireless-network-interface-controller-computer-network-electronics-network.png",
    },
    {
      ...
      warehouse_id: new mongoose.Types.ObjectId("65279b7f69f7b3c23ef9e0a7"),
      image:
        "https://e7.pngegg.com/pngimages/972/274/png-clipart-wd-my-cloud-ex2-ultra-network-storage-systems-terabyte-western-digital-auto-body-cart-plans.png",
    },
    {
    ...
    },
    {
      ...
      warehouse_id: new mongoose.Types.ObjectId("65279b7f69f7b3c23ef9e0a6"),
      image:
        "https://e7.pngegg.com/pngimages/453/872/png-clipart-kaspersky-lab-kaspersky-internet-security-endpoint-security-kaspersky-anti-virus-antivirus-software-cloud-security-internet-software.png",
    },
    {
    ...
    },
    {
      ...
      warehouse_id: new mongoose.Types.ObjectId("65279b7f69f7b3c23ef9e0a7"),
      image:
        "https://w7.pngwing.com/pngs/492/992/png-transparent-logo-vmware-vsphere-vcenter-virtualization-citrix-receiver-icon-text-logo-area.png",
    },
  ];
